        ...
        if(!mysqli_stmt_prepare($stmt, $sql)){
            ...
            if($check > 0){
                ...
                if(!mysqli_stmt_prepare($stmt, $sql)){
                    ...
                    mysqli_stmt_bind_param($stmt, "sssss", $fname, $lname, $username,$hashed,$email);
                    mysqli_stmt_execute($stmt);
                    mysqli_stmt_store_result($stmt);

                    $sqlImg = "INSERT INTO profiles (fname, uname) VALUES ('$fname', '$username')";
